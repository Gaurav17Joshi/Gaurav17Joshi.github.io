...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Projects",
          description: "Some projects I think are worth sharing.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-computational-statistics-ebook",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/bhai_joshi17", "_blank");
        },
      },{
      id: 'light-theme',
